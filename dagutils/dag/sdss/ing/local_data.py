...
root.workflow["association"].task["isr"].preJob.script.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/templates/preJob.sh.template"
root.workflow["association"].task["isr"].preJob.script.outputFile = "preJob.sh"
root.workflow["association"].task["isr"].preJob.condor.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/templates/preJob.condor.template"
root.workflow["association"].task["isr"].preJob.condor.outputFile = "S2012Pipe.pre"

root.workflow["association"].task["isr"].postJob.script.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/templates/postJob.sh.template"
root.workflow["association"].task["isr"].postJob.script.outputFile = "postJob.sh"
root.workflow["association"].task["isr"].postJob.condor.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/templates/postJob.condor.template"
root.workflow["association"].task["isr"].postJob.condor.outputFile = "S2012Pipe.post"

root.workflow["association"].task["isr"].workerJob.script.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/templates/worker.sh.template"
root.workflow["association"].task["isr"].workerJob.script.outputFile = "worker.sh"
root.workflow["association"].task["isr"].workerJob.condor.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/templates/workerJob.condor.template"
...
root.workflow["association"].task["isr"].preJob.script.keywords["DBNAME"] = "daues_S12_sdss_u_s2012prod_im0200c"
root.workflow["association"].task["isr"].preJob.script.keywords["DBHOST"] = "lsst-db.ncsa.illinois.edu"
root.workflow["association"].task["isr"].preJob.script.keywords["DBUSER"] = "daues"

root.workflow["association"].task["isr"].preJob.script.keywords["PCDDREFRUN"] = "s2012pcdd_sd0215"
root.workflow["association"].task["isr"].preJob.script.keywords["OUTREFRUN"] = "s2012outc_sd0214"
root.workflow["association"].task["isr"].preJob.script.keywords["SAREFRUN"] = "s2012sa_sd0203"
...
root.workflow["association"].task["isr"].dagGenerator.script = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/scripts/newgenerateDag.py"
root.workflow["association"].task["isr"].dagGenerator.idsPerJob=1
# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/input/80000.sdss.input"

# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/input/19260.sdss.input"

# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/input/10.sdss.input"
# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/input/2000.sdss.input"
# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/input/144.sdss.input"
# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/ing/dag/input/4608.sdss.input"
