...
def writeDagFile(pipeline, templateFile, infile, workerdir, prescriptFile, runid):
    ...
    for aline in fileObj:
        ...
        if " " in myData:
            ...
            # Change tract to t
            myList4  = new3Data.split("tract");
            new4Data = '%st%s' % tuple(myList4)
            # Change patch to p
            myList5  = new4Data.split("patch");
            new5Data = '%sp%s' % tuple(myList5)
        ...
        # print acount, "myData ", myData
        # print acount, "newData ", newData
