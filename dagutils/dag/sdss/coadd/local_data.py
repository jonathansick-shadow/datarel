...
root.workflow["association"].task["isr"].preJob.script.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/templates/preJob.sh.template"
root.workflow["association"].task["isr"].preJob.script.outputFile = "preJob.sh"
root.workflow["association"].task["isr"].preJob.condor.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/templates/preJob.condor.template"
root.workflow["association"].task["isr"].preJob.condor.outputFile = "S2012Pipe.pre"

root.workflow["association"].task["isr"].postJob.script.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/templates/postJob.sh.template"
root.workflow["association"].task["isr"].postJob.script.outputFile = "postJob.sh"
root.workflow["association"].task["isr"].postJob.condor.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/templates/postJob.condor.template"
root.workflow["association"].task["isr"].postJob.condor.outputFile = "S2012Pipe.post"

root.workflow["association"].task["isr"].workerJob.script.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/templates/worker.sh.template"
root.workflow["association"].task["isr"].workerJob.script.outputFile = "worker.sh"
root.workflow["association"].task["isr"].workerJob.condor.inputFile = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/templates/workerJob.condor.template"
...
root.workflow["association"].task["isr"].dagGenerator.script = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/scripts/newgenerateDag.py"
root.workflow["association"].task["isr"].dagGenerator.idsPerJob=1
# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/input/80000.sdss.input"

# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/input/19260.sdss.input"

# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/input/10.sdss.input"
# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/input/2000.sdss.input"
# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/input/144.sdss.input"
# root.workflow["association"].task["isr"].dagGenerator.input = "$DATAREL_DIR/dagutils/dag/sdss/coadd/dag/input/4608.sdss.input"
